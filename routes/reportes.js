...
const { reportesGet, reporteGet, reportesPost, reportesPut, reportesDelete, reportesPatch, uploadFoto, reporteGetByFolio } = require('../controllers/reportes');
const { validarCampos } = require('../middlewares/validar-campos');
const router = Router();

router.get('/',  reportesGet);
router.get('/:id', reporteGet);
router.get('/folio/:id', reporteGetByFolio);
router.post('/', [
