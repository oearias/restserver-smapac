const queries = {
    ...
    'dbo.mes_anterior(@id, 2021, 13, 1) as lectura1, '+
    ...
    'dbo.adeudo(@id, 2021, 13, 1) as adeudo1, '+    //Enero
    ...
    'dbo.fecha_emision(@id, 2021, 13, 1) as fecha_emision1, '+
    ...
    'dbo.mes_facturado(@id, 2021, 13, 1) as mes_facturado1, '+
    ...
    'AND a.mes = 1 '+ //TODO: Este debe cambiar a 1 con la facturación de Enero
